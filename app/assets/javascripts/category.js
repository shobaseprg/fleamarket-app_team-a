$(function() {
	...
	function childBox(insertHTML) {
		let childBoxHTML =
			`<div class="sell__main__content__form__box__group__select" id="child_box">
	...
	function grandChildBox(insertHTML) {
		let grandChildBoxHTML =
			`<div class="sell__main__content__form__box__group__select" id="grandchild_box">
                              <i class="icon-arrow-bottom"></i>
